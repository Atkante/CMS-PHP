...
<?php require_once "Client/includes/conexion.php";?>
<?php require_once "Client/includes/header.php";  ?>
        ...
        <div class="services-slider swiper" data-aos="fade-up" data-aos-delay="100">
          ...
          <?php
                ...
                if (!$resultado->execute()) {
                  die("Fallo en la consulta UnU");
                }else{
                  while($reg=$resultado->fetch()){
                    $cat_titulo=$reg["CaTitulo"];
                    $cat_descripcion=$reg["descripcionCategorias"];
                    $cat_icono=$reg["IconoCategoria"];
                    echo "  <div class='swiper-slide'>
                    <div class='services-block'>";

                    echo"<img src='data:image/jpg;base64,";
                    echo base64_encode($cat_icono);
                    echo"' alt=''>";

                    echo"<span>$cat_titulo</span>";
                    echo"<p class='separator'>$cat_descripcion</p>";
                    echo" </div>
                    </div>";
                  }
                }
